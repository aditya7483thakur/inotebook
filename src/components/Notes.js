                        ...
                        <div className="modal-body">
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" name='etitle' onChange={onChange} minLength={5} value={note.etitle} id="etitle" aria-describedby="emailHelp" />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="edescription" className="form-label">Description</label>
                                    <input type="text" name='edescription' className="form-control" value={note.edescription} onChange={onChange}  minLength={5} id="edescription" />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="etag" className="form-label">Tag</label>
                                    <input type="text" name='etag' className="form-control" value={note.etag} onChange={onChange} id="etag" />
                                </div>
                            </form>
                        </div>
